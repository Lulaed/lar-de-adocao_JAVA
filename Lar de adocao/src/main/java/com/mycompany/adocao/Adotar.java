...
public final class Adotar extends javax.swing.JFrame {
...
// adicionar o JScrollPane ao painel existente
    ...
    private void initComponents() {
        ...
        jLabel1Addbook2.setText("Adicionar Animal");
        ...
        jLabel1Addbook3.setText("Excluir Animal");
        ...
        jLabel1Addbook4.setText("Alterar Animal");
        ...
        btnShow1.setText("Gerenciar Lares");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        colecao = conexao.getBanco().getCollection("Animais");
         Document a1 = new Document();

        a1
            .append("Nome", jtitulo.getText())
            .append("Especie", jTextFieldAutor.getText())
            .append("Genero", jTextFieldGenero.getText());
    ...
    private void btnShowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnShowActionPerformed
        ...
        colecao= conexao.getBanco().getCollection("Animais");
         ...
         try {
             TEXTO2.append("---------Lista de Animais disponiveis--------\n\n");
        ...
        TEXTO2.append("Espécie:" + livro.get("Especie").toString() + "\n");
        TEXTO2.append("Gênero:" +livro.get("Genero").toString() + "\n");
        TEXTO2.append("----------------- \n");
